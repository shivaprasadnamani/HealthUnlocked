...
public class ProfilePageTest extends BaseTest{
	...
	public void verifyAddANewCondition(){
		...
		final String conditions = "thyrotoxicosis";
	...
	public void verifyAddANewTreatment(){
		...
		final String treatment = "methotrexate";
	...
	public void verifyAddBioToProfile(){
		...
		final String bio = "Hello world! I am a test user for https://healthunlocked.com";
